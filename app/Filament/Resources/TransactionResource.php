...
//                )
            ...
            ->recordUrl(fn (Transaction $record) => $record->type !== TransactionTypeEnum::TRANSFER->name ? route('filament.admin.resources.transactions.view', $record) : null)
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Section::make('Informações da Transação')
                    ->schema([
                        TextEntry::make('type')
                            ->label('Tipo')
